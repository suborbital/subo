...
func PushCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "push",
		Short: "push the project to bindle",
		Long:  "package the Directive.yaml, built .wasm files, and static directory into a bindle, and push it to a bindle server",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			util.LogStart(fmt.Sprintf("pushing %s@%s", bctx.Directive.Identifier, bctx.Directive.AppVersion))

			invoice := &types.Invoice{
				BindleVersion: "1.0.0",
				Bindle: types.BindleSpec{
					Name:    bctx.Directive.Identifier,
					Version: strings.TrimPrefix(bctx.Directive.AppVersion, "v"),
					Authors: []string{
						suboAuthor,
					},
				},
			...
			if err := os.WriteFile(filepath.Join(bctx.Cwd, "Invoice.toml"), invoiceBytes, 0600); err != nil {
