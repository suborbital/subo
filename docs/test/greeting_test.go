...
// This comment is associated with the ExampleHello_doNotDoThis extension example.
...
// This comment is associated with the ExampleHello_doThis extension example.
